...
class Lv3:BaseLevelScene{
    ...
    override func didMove(to view: SKView) {
        ...
        parallax = Parallax(scene: self, items: [
            .init(fileName: "New Planet", velocityFactor: 0, zIndex: -5, offset: CGVector(dx: 500, dy: 500)),
            .init(fileName: "New Planet", velocityFactor: 0, zIndex: -5, offset: CGVector(dx: 500, dy: 1500)),
